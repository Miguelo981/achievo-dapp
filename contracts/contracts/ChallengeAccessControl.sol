...
/// @title A facet of ChallengeCore that manages special access provileges.
...
contract ChallengeAccessControl {
    // The address of the account (or contract) that can execute actions within each role.
    address payable public serviceOwner;

    // The minimum stake required in order to create a challenge.
    ...
    function transferOwnership(address payable _newOwner) public onlyServiceOwner {
